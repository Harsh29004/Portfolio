        ...
        >
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <motion.div variants={itemVariants} className="space-y-6">
              ...
              >
                <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-primary/30 to-secondary/30 rounded-full blur-2xl"></div>
                <div className="relative z-10">
                  ...
                  <div className="flex gap-3">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex-1 px-3 py-2 bg-gradient-to-r from-primary to-secondary rounded-lg font-semibold text-sm text-center hover:scale-105 transition-transform"
                    >
                      View GitHub
                    </a>
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex-1 px-3 py-2 border border-primary text-primary rounded-lg font-semibold text-sm text-center hover:bg-primary hover:text-dark transition-all"
                    >
                      LinkedIn
                    </a>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-3 py-2 text-sm bg-dark/50 border border-gray-700 rounded-lg focus:border-primary focus:outline-none text-white transition-colors"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      rows="4"
                      className="w-full px-3 py-2 text-sm bg-dark/50 border border-gray-700 rounded-lg focus:border-primary focus:outline-none text-white transition-colors resize-none"
                  ...
                  <motion.button
                    ...
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className="w-full px-4 py-2.5 bg-gradient-to-r from-primary to-secondary rounded-lg font-semibold text-sm disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                  >
                    {isSubmitting ? (
